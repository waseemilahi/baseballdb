        ...
        try {
            ...
            if(count >0)
            {
             ...
             while(r.next()){
            	 ...
            	 out.println("<td>" + "<form action= \"AgentIDServlet\" method = \"POST\"><input type=\"checkbox\" name=\"agent1\" style = \"visibility:hidden\" checked><input type=\"checkbox\" name=\"agent2\" style = \"visibility:hidden\" checked><input type = \"submit\" value = \""+r.getString(count+1)+ "\"><input type=\"checkbox\" name=\"agent3\" style = \"visibility:hidden\" checked><input type=\"checkbox\" name=\"agent4\" style = \"visibility:hidden\" checked><br><input type=\"text\" name = \"AgentID\" value = \"'"+r.getString(count+1)+"'\" style = \"visibility:hidden\"></form>" + "</td>");
            	 out.println("<td>" + "<form action= \"TeamIDServlet\" method = \"POST\"><input type=\"checkbox\" name=\"team1\" style = \"visibility:hidden\" checked><input type=\"checkbox\" name=\"team2\" style = \"visibility:hidden\" checked><input type=\"checkbox\" name=\"team3\" style = \"visibility:hidden\" checked><input type = \"submit\" value = \""+r.getString(count+2)+ "\"><input type=\"checkbox\" name=\"team4\" style = \"visibility:hidden\" checked><input type=\"checkbox\" name=\"team5\" style = \"visibility:hidden\" checked><input type=\"checkbox\" name=\"team6\" style = \"visibility:hidden\" checked><br><input type=\"text\" name = \"TeamID\" value = \""+r.getString(count+2)+"\" style = \"visibility:hidden\"></form>" + "</td>");
            	 }
                	 ...
                	 out.println("<td>" + "<form action= \"TeamIDServlet\" method = \"POST\"><input type=\"checkbox\" name=\"team1\" style = \"visibility:hidden\" checked><input type=\"checkbox\" name=\"team2\" style = \"visibility:hidden\" checked><input type=\"checkbox\" name=\"team3\" style = \"visibility:hidden\" checked><input type = \"submit\" value = \""+r.getString(count+1)+ "\"><input type=\"checkbox\" name=\"team4\" style = \"visibility:hidden\" checked><input type=\"checkbox\" name=\"team5\" style = \"visibility:hidden\" checked><input type=\"checkbox\" name=\"team6\" style = \"visibility:hidden\" checked><br><input type=\"text\" name = \"TeamID\" value = \""+r.getString(count+1)+"\" style = \"visibility:hidden\"></form>" + "</td>");
