	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if(count >0)
            {
             ...
             out.println( "<form action= \"StaffServlet\" method = \"POST\"><div  align=\"center\">" );
             ...
             out.println("<center><input type=\"submit\" value=\"Staff Table\" style=\"horizontal-align:middle;\"></center>");
